  ...
  try {
    ...
    for (const match of activeMatches) {
          ...
          $facet: {
            ...
            topRuns: [
              ...
              { $group: {
                  ...
                  players: { $push: { name: "$players.name", runs: "$players.runs" } }
                }
              },
              { $project: {
                  topScorers: {
            ...
            topWickets: [
              ...
              { $group: {
                  ...
                  players: { $push: { name: "$players.name", wickets: "$players.wickets" } }
                }
              },
              { $project: {
                  topBowlers: {
            ...
            topCatches: [
              ...
              { $group: {
                  ...
                  players: { $push: { name: "$players.name", catches: "$players.catch" } }
                }
              },
              { $project: {
                  topFielders: {
            ...
            topSixes: [
              ...
              { $group: {
                  ...
                  players: { $push: { name: "$players.name", sixes: "$players.sixes" } }
                }
              },
              { $project: {
                  topHitters: {
      ...
      if(summary && summary.length){
        await Match.updateOne({matchId: match.matchId},{$set:{
